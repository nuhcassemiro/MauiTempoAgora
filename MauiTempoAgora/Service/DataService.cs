...
namespace MauiTempoAgora.Service
{
    public class DataService
    {
        public static async Task<Tempo?> GetPrevisaoDoTempo(string cidade)
        {
            ...
            string appId = "6135072afe7f6cec1537d5cb88a5a1a2";

            string url = $"http://api.apenweathermap.org/data/2.5/weather?q={cidade}&units=metric&appid={appId}";
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    // https://stackoverflow.com/questions/6239976/how-to-set-a-time-zone
